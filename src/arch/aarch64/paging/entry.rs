...
impl Entry {
    ...
    pub fn page_table_entry_set(&mut self, frame: Frame, flags: TableDescriptorFlags) {
        ...
        self.0 = (frame.start_address().get() as u64) | flags.bits() | access_flag.bits() | (self.0 & COUNTER_MASK);
    }
    ...
    pub fn set(&mut self, frame: Frame, flags: EntryFlags) {
        ...
        self.0 = (frame.start_address().get() as u64) | translated_flags.bits() | (self.0 & COUNTER_MASK);
    }
